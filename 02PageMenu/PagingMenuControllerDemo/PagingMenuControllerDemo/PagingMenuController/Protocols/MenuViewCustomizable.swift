...
public protocol MenuViewCustomizable {
    ...
    var selectBackgroundColor: UIColor { get }
    ...
    var itemOptions: [MenuItemViewCustomizable] { get }
}
...
public extension MenuViewCustomizable {
    ...
    var displayMode: MenuDisplayMode {
        return .standard(widthMode: .flexible, centerItem: false, scrollingMode: .pagingEnable)
    }
    
    var focusMode: MenuFocusMode {
        return .underline(height: 3, color: .blue, horizontalPadding: 0, verticalPadding: 0)
    }
    
    var dummyItemViewSet: Int {
        return 3
    }
